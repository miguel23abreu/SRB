    ...
    <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel" aria-labelledby="stats-tab">
            <div class="flex flex-col items-center justify-center">
                ...
                <button class="mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none" wire:click="startFocusTimer">Iniciar</button>
            </div>
        </div>
        ...
        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="faq" role="tabpanel" aria-labelledby="faq-tab">
            <div class="flex flex-col items-center justify-center">
                ...
                <button class="mt-4 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none" wire:click="startLongBreakTimer">Iniciar</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('livewire:load', function () {
        Livewire.on('startFocusTimer', () => startFocusTimer());
        Livewire.on('startShortBreakTimer', () => startShortBreakTimer());
        Livewire.on('startLongBreakTimer', () => startLongBreakTimer());
    });
</script>
@endpush